...
class Clothing {
    class bruce {
        ...
        uniforms[] = {
            ...
            { "U_C_Poloshirt_redwhite", "Polo Red", 125, { "", "", -1 } },
            { "U_C_Poloshirt_stripped", "Polo Green", 125, { "", "", -1 } },
    ...
    class med_clothing {
        ...
        uniforms[] = {
            { "NONE", "Remove Uniform", 0, { "", "", -1 } },
            { "U_B_CombatUniform_mcam", "THW Uniform", 50, { "", "", -1 } }
        };
        headgear[] = {
            { "NONE", "Remove Hat", 0, { "", "", -1 } },
    ...
    class gang {
        ...
        headgear[] = {
			...
			{ "H_HelmetLeaderO_ocamo", "", 100, { "", "", -1 } },
			{ "H_HelmetLeaderO_ghex_F", "", 100, { "", "", -1 } },
			{ "H_HelmetO_ViperSP_ghex_F", "", 100, { "", "", -1 } },
			{ "H_HelmetO_ViperSP_hex_F", "", 100, { "", "", -1 } },
			{ "H_Shemag_khk", "", 100, { "", "", -1 } },
			{ "H_Shemag_tan", "", 100, { "", "", -1 } },
			{ "H_Shemag_olive", "", 100, { "", "", -1 } },
			{ "H_Shemag_olive_hs", "", 100, { "", "", -1 } },
