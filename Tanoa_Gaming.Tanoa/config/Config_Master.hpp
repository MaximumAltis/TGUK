...
/* Database Related Settings */
    ...
    saved_virtualItems[] = { "coconut", "artifactold", "defibrillator", "artifactoldp", "artifactnew", "artifactnewp", "gold","goldp", "sugar", "waterBottle", "tbacon", "redgull","pickaxe", "bloodbag", "toolkit", "fuelFull", "lockpick", "turtleRaw", "coffee", "turtleSoup", "heroinProcessed", "marijuana", "cocaineProcessed", "lumber2", "lumber_processed","salemaRaw", "salema", "mackerelRaw", "mackerel", "tunaRaw", "tuna", "mineral", "mineral_processed", "tobacco", "tobacco_processed", "spikeStrip", "sheepRaw", "sheep", "goatRaw", "goat" }; //Array of virtual items that can be saved on your player.
    ...
    save_vehicle_items[] = { "coconut","pickaxe","bloodbag","artifactold","defibrillator", "artifactoldp", "artifactnew", "artifactnewp", "gold","goldp","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","peach","tbacon","donuts","rabbit","salema","ornate","mackerel", "lumber2", "lumber_processed","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit" };
...
/* System Settings */
    ...
    service_chopper = 14000; //Cost to service chopper at chopper service station(Repair/Refuel).
    fuelCan_refuel = 9750; //Cost to refuel an empty fuel canister at the fuel station pumps. (Be wary of your buy/sell prices on fuel cans to prevent exploits...)
    ...
    animaltypes_fish[] = { "Salema_F", "Mackerel_F", "Tuna_F", "Turtle_F" }; //Classnames of fish you can catch
    animaltypes_hunting[] = { "Sheep_random_F", "Goat_random_F" }; //Classnames of aniamls you can hunt/gut
    ...
    hospital_heal_fee = 12000; //Fee to heal at a hospital NPC
    ...
    vehicle_infiniteRepair[] = {true, false, true, false}; //Set to true for unlimited repairs with 1 toolkit. False will remove toolkit upon use. civilian, west, independent, east
