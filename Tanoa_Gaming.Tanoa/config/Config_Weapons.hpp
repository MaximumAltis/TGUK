...
class WeaponShops {
    ...
    class rebel {
        name = "Guerrilla Armory";
        side = "civ";
        license = "rebel";
        level[] = { "", "", -1, "" };
        items[] = {
            { "NONE", "---------------------------------------------------------------------------",0, -1 },
            { "NONE", "Assault Rifles",0, -1 },
            { "NONE", "---------------------------------------------------------------------------",0, -1 },
    ...
    //Cop Shops
    class cop_basic {
        name = "Tanoa Police Shop";
        side = "cop";
        license = "";
        level[] = { "life_coplevel", "SCALAR", 1, "You must be a Police community support officer!" };
        items[] = {
            { "ItemRadio", "Handy",800, -1 },
            { "ItemGPS", "",100, -1 },
            { "Binocular", "",100, -1 },
    ...
    class cop_cadet {
        ...
        side = "cop";
        license = "";
        level[] = { "life_coplevel", "SCALAR", 2, "You must be a Police Constable!" };
        items[] = {
            { "hgun_P07_snds_F","Taser Pistol",500, -1 },
        ...
        mags[] = {
            ...
            { "20Rnd_556x45_UW_mag","Taser 16rnd",100, -1 },
    ...
    class cop_officer {
        ...
        side = "cop";
        license = "";
        level[] = { "life_coplevel", "SCALAR", 3, "You must be a Senior Police Constable!" };
        items[] = {
            { "hgun_P07_snds_F","Taser Pistol",500, -1 },
            { "arifle_SDAR_F","Taser Rifle",15000, -1 },
            { "SMG_05_F", "",5000, -1 },
    ...
    class cop_statetrooper {
        ...
        side = "cop";
        license = "";
        level[] = { "life_coplevel", "SCALAR", 5, "You must be a Senior Sergeant!" };
        items[] = {
            { "hgun_P07_snds_F","Taser Pistol",500, -1 },
            { "arifle_SDAR_F","Taser Rifle",15000, -1 },
            { "SMG_05_F", "",5000, -1 },
            ...
            { "bipod_01_F_blk", "",10000, -1 },
            { "bipod_01_F_snd", "",10000, -1 },
            { "1Rnd_SmokeGreen_Grenade_shell","",15000, -1 },
    ...
    class cop_sergeant {
        ...
        side = "cop";
        license = "";
        level[] = { "life_coplevel", "SCALAR", 6, "You must be a Inspector!" };
        items[] = {
            { "hgun_P07_snds_F","Taser Pistol",500, -1 },
            { "arifle_SDAR_F","Taser Rifle",15000, -1 },
            { "SMG_05_F", "",5000, -1 },
    ...
    class cop_staffsergeant {
        ...
        side = "cop";
        license = "";
        level[] = { "life_coplevel", "SCALAR", 7, "You must be a Chief Inspector!" };
        items[] = {
            { "hgun_P07_snds_F","Taser Pistol",500, -1 },
            { "arifle_SDAR_F","Taser Rifle",15000, -1 },
            { "SMG_05_F", "",5000, -1 },
    ...
    class cop_lieutenant {
        ...
        side = "cop";
        license = "";
        level[] = { "life_coplevel", "SCALAR", 8, "You must be a Super Intendent!" };
        items[] = {
			{ "hgun_P07_snds_F","Taser Pistol",500, -1 },
            { "arifle_SDAR_F","Taser Rifle",15000, -1 },
            { "SMG_05_F", "",5000, -1 },
    ...
    class cop_1stlieutenant {
        ...
        side = "cop";
        license = "";
        level[] = { "life_coplevel", "SCALAR", 9, "You must be a Assistant Commissioner!" };
        items[] = {
			{ "hgun_P07_snds_F","Taser Pistol",500, -1 },
            { "arifle_SDAR_F","Taser Rifle",15000, -1 },
            { "SMG_05_F", "",5000, -1 },
    ...
    class cop_captain {
        ...
        side = "cop";
        license = "";
        level[] = { "life_coplevel", "SCALAR", 10, "You must be a Commissioner!" };
        items[] = {
            { "hgun_P07_snds_F","Taser Pistol",500, -1 },
            { "arifle_SDAR_F","Taser Rifle",15000, -1 },
            { "SMG_05_F", "",5000, -1 },
    ...
    class cop_inspector {
        ...
        side = "cop";
        license = "";
        level[] = { "life_coplevel", "SCALAR", 11, "You must be a Commissioner!" };
        items[] = {
            { "hgun_P07_snds_F","Taser Pistol",500, -1 },
            { "arifle_SDAR_F","Taser Rifle",15000, -1 },
            { "SMG_05_F", "",5000, -1 },
    ...
    class cop_2ndchief {
        ...
        side = "cop";
        license = "";
        level[] = { "life_coplevel", "SCALAR", 12, "NONE!" };
        items[] = {
            { "hgun_P07_snds_F","Taser Pistol",500, -1 },
            { "arifle_SDAR_F","Taser Rifle",15000, -1 },
            { "SMG_05_F", "",5000, -1 },
