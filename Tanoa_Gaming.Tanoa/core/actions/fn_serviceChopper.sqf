...
if (!alive (_search select 0) || (_search select 0) distance air_sp_1 > 15) exitWith {life_action_inUse = false; hint localize "STR_Service_Chopper_Missing"};
if (!alive (_search select 0) || (_search select 0) distance air_sp_2 > 15) exitWith {life_action_inUse = false; hint localize "STR_Service_Chopper_Missing"};
if (!alive (_search select 0) || (_search select 0) distance air_sp_3 > 15) exitWith {life_action_inUse = false; hint localize "STR_Service_Chopper_Missing"};
if (!alive (_search select 0) || (_search select 0) distance air_sp_4 > 15) exitWith {life_action_inUse = false; hint localize "STR_Service_Chopper_Missing"};
