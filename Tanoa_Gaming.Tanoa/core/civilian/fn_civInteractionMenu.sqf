...
if((_curTarget getVariable["Escorting",false])) then {
  ...
  if((_curTarget getVariable["restrainedType"] == "zip") && (_curTarget getVariable["restrainedType"] != "cuff")) then {
    _Btn2 ctrlSetText localize "STR_pInAct_Escort";
    _Btn2 buttonSetAction "[life_pInact_curTarget] call life_fnc_escortAction; closeDialog 0;";
  };
};

if(((animationState _curTarget) == "Incapacitated")
 OR (_curTarget getVariable["restrainedType","zip",true]) && (_curTarget getVariable["restrainedType","cuff",false])) then
{
    ...
    _Btn3 ctrlSetText "Cannot Rob Player";
