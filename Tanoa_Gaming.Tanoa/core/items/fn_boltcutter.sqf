...
if (((nearestObject [[11715.5,3168.84,0],"Land_Dome_Big_F"]) == _building || (nearestObject [[11717.9,3173.73,0],"Land_Cargo_HQ_V4_F"]) == _building) && (west countSide playableUnits < (LIFE_SETTINGS(getNumber,"minimum_cops")))) exitWith {
    hint format [localize "STR_Civ_NotEnoughCops",(LIFE_SETTINGS(getNumber,"minimum_cops"))]
};
if ((typeOf _building) == "Land_Cargo_HQ_V4_F" && (nearestObject [[11715.5,3168.84,0],"Land_Dome_Big_F"]) getVariable ["locked",true]) exitWith {hint localize "STR_ISTR_Bolt_Exploit"};
...
if ((nearestObject [[11715.5,3168.84,0],"Land_Dome_Big_F"]) == _building || (nearestObject [[11717.9,3173.73,0],"Land_Cargo_HQ_V4_F"]) == _building) then {
...
switch (typeOf _building) do {
    ...
    case "Land_Cargo_HQ_V4_F": {_cpRate = 0.0015;};
