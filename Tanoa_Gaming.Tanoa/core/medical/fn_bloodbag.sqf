...
if(!isNil "_badDistance") exitWith {titleText["You got too far away from the target.","PLAIN"]; life_action_inUse = false; _curTarget setVariable["bloodBagged",false,true];};
...
//_val = 1500;
//if(playerSide isEqualTo independent) then { ADD(CASH,_val); hint "You have received £1,500 for your services"; };
